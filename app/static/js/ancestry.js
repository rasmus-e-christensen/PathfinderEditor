...
function changeAncestryBoostSelect(){
   var id = 'ancestry_boost_select';
   var boost_select = document.getElementById(id).value.toLowerCase();
   var ability_score = boost_select.substring(0, 3);
   var value = parseInt(document.getElementById(ability_score.concat('_ances_mod')).innerHTML);
   document.getElementById(ability_score.concat("_ances_mod")).innerHTML = value + 2;
   previous_select_reset(id, ability_score);
}

function changeAncestryBoostSelectSecond(){
   var id = 'ancestry_boost_select_1';
   var boost_select = document.getElementById(id).value.toLowerCase();
   var ability_score = boost_select.substring(0, 3);
   var value = parseInt(document.getElementById(ability_score.concat('_ances_mod')).innerHTML);
   document.getElementById(ability_score.concat("_ances_mod")).innerHTML = value + 2;
